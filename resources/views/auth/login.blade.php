            ...
            <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                <div>
                    <h2 class="lg:text-5xl text-4xl font-extrabold lg:leading-[55px] text-gray-800">
                        {{ __('app_translation.apiloginpage') }}
                    </h2>
                    <p class="text-sm mt-6 text-gray-800">only master user .</p>

                </div>

                <form class="max-w-md md:ml-auto w-full" method="POST" action="{{ route('web.authintiction') }}">
