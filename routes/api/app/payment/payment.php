...
Route::prefix('v1')->middleware(["authorized:" . 'finance:api'])->group(function () {
    Route::post('/finance/payment/store', [PaymentController::class, "store"])->middleware(["financeHasSubPermission:" . PermissionEnum::configurations->value . "," . SubPermissionEnum::configuration_job->value . ',' . 'add']);
