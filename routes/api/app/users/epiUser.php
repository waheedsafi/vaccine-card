...
Route::prefix('v1')->middleware(["authorized:" . 'epi:api'])->group(function () {
    ...
    Route::post('/epi/user/update/information', [EpiUserController::class, 'updatePersonalInformation'])->middleware(['checkEpiAccess', "epiHasSubPermission:" . PermissionEnum::users->value . "," . SubPermissionEnum::user_information->value . ',' . 'edit']);
